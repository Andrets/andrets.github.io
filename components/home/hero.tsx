...
const text = () => (
  <div className="group mt-36.75 bg-surface pl-16 pt-12 pb-11 rounded-[5rem] relative overflow-hidden">
    <div
      className="absolute inset-0 rounded-[5rem] p-[1px] pointer-events-none"
      style={{
        background:
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-secondary-grey max-w-[75%]">
            ...
            Создаю высоконагруженные SaaS-платформы на Bun и Next.js, интегрируя
            возможности современных LLM в бизнес-процессы.
          </p>
        </div>
      </div>
...
export function Hero() {
  return (
    <div className="max-w-width mx-auto">
      <div className="group mt-36.75 bg-surface pl-16 pt-12 pb-11 rounded-[5rem] relative">
        <div
        ...
        <Blob type="small" className="bg-red bottom-0 right-1/3" />
      </div>
    </div>
  );
}
